...
import { PersonalizationInputRequest, PersonalizationInputResponse } from 'react-native-mdl'
...
export const DrivingLicenseForm = () => {
    ...
    const handleSubmit = async () => {
        const responses: PersonalizationInputResponse[] = Object.entries(inputs).map(([key, value]) => {
    ...
    const isSubmitDisabled = Object.entries(inputs).every(([_, value]) => !value.length)

    return (
        <FormContainer
            title={"Driving License"}
            description={"Submit your personal information to receive your Driving License"}
