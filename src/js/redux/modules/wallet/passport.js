...
const options = listOfCountries.map(({name}) => name)
...
module.exports.default = (state = initialState, action = {}) => {
  switch (action.type) {
    ...
    case actions.save.id:
      return state.mergeIn({loaded: false})

    case actions.retrievePassportInformation.id:
      return state.mergeIn({loaded: false})

    case actions.retrievePassportInformation.id_fail:
      return state.mergeIn({loaded: true, showErrors: true})

    case actions.retrievePassportInformation.id_success:
      return state.mergeIn({loaded: true, showErrors: false})

    case actions.chooseCountry.id:
      return state
