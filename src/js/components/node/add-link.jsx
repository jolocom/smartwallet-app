...
let NodeAddLink = React.createClass({
  ...
  propTypes: {
    ...
    onSuccess: React.PropTypes.any,
    selection: React.PropTypes.any,
    full: React.PropTypes.any,
    targetSelection: React.PropTypes.any,
    field: React.PropTypes.any,
    label: React.PropTypes.any,
    onChangeEnd: React.PropTypes.any,
    onSelectTarget: React.PropTypes.any
  },
  ...
  handleChangeEnd: function(event) {
    this.setState({endUri: event.target.value, end: event.target.value})
  },

  handleChangeStart: function(event) {
    this.setState({startUri: event.target.value, start: event.target.value})
  },
