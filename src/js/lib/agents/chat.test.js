...
describe('ChatAgent', function () {
  let p1 = 'https://p1.webid.jolocom.de/profile/card#me'
  let p2 = 'https://p2.webid.jolocom.de/profile/card#me'
  let p3 = 'https://p3.webid.jolocom.de/profile/card#me'

  describe('#createConversation', function () {
    it('should create a conversation', async function () {
      const conversationId = randomString(5)

      const conversationFetch = async (url, options) => {
      ...
      const aclFetch = async (url, options) => {

      }

      const fetches = {
        [`${p1}/little-sister/chats/${conversationId}`]: conversationFetch,
        [`${p1}/little-sister/inbox`]: linkFetch,
        [`${p2}/little-sister/inbox`]: linkFetch,
        [`${p1}/little-sister/chats/${conversationId}.acl`]: aclFetch
      }
    ...
    it('should create a group conversation', function() {

    })

    it('should link conversation to all participants', function() {
  ...
  describe('#removeUnreadMessage', function() {
