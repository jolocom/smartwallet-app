...
import { genericActions } from 'src/actions/' // navigationActions,
...
//     const { jolocomLib, keyChainLib, encryptionLib, ethereumLib } = backendMiddleware
//     let newClaims = {}
...
// const prepareClaimsForState = (claims: SignedCredential[]) => {
