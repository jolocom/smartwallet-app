  ...
  return (
    <View style={styles.mainContainer}>
      <ClaimCardWrapper
        ...
        containerStyle={props.containerStyleWrapper || styles.containerStyleWrapperDefault}
        title={props.title}
      />
      <ClaimCard
        ...
        containerStyle={props.containerStyleClaimCard || styles.containerStyleClaimCardDefault}
